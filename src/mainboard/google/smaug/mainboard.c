...
static const struct pad_config additional_padcfgs[] = {
	...
	PAD_CFG_GPIO_OUT1(TOUCH_RST, PINMUX_PULL_NONE),
	PAD_CFG_SFIO(TOUCH_CLK, PINMUX_PULL_NONE, TOUCH),
	PAD_CFG_UNUSED_WITH_RES(MODEM_WAKE_AP, RES0),
	...
	PAD_CFG_GPIO_INPUT(HDMI_INT_DP_HPD, PINMUX_PULL_NONE),
	...
	PAD_CFG_GPIO_INPUT(DP_HPD0, PINMUX_PULL_NONE),
