...
enum {
	...
	/* GPIO6 - unused */
	PAD_GPIO(7, SDMMC3_CLK,  POR_PD, P0, SDMMC3, RES1, RES2, RES3),
	PAD_GPIO(8, SDMMC3_CMD,  POR_PU, P1, SDMMC3, RES1, RES2, RES3),
	PAD_GPIO(9, SDMMC3_DAT0, POR_PU, P2, SDMMC3, RES1, RES2, RES3),
	PAD_GPIO(10, SDMMC3_DAT1, POR_PU, P3, SDMMC3, RES1, RES2, RES3),
	PAD_GPIO(11, SDMMC3_DAT2, POR_PU, P4, SDMMC3, RES1, RES2, RES3),
	PAD_GPIO(12, SDMMC3_DAT3, POR_PU, P5, SDMMC3, RES1, RES2, RES3),
	/* GPIO13 - unused */
